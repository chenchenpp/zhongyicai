...
.directive('progress', function() {
    return {
        ...
        //templateUrl: 'templates/progressbar/progress.html' // Works in AngularJS 1.2
    };
})
        ...
        return {
            ...
            link:function (originalScope, element, attrs, modelCtrl) {
                ...
                if (angular.isDefined(attrs.typeaheadTemplateUrl)) {
                    popUpEl.attr('templates-url', attrs.typeaheadTemplateUrl);
                }
...
.directive('typeaheadPopdown', function () {
    return {
        ...
        replace:true,
        templateUrl:'templates/typeahead/typeahead-popdown.html',
        link:function (scope, element, attrs) {
